      ...
      <div className="container-custom relative z-10" ref={containerRef}>
            ...
            {workHistory.map((job, index) => (
              ...
              >
                ...
                <div className="ml-16 flex-1">
                  <motion.div
                    whileHover={{ y: -4 }}
                    className="bg-primary-50 dark:bg-primary-900 rounded-2xl p-8 shadow-sm border border-primary-200 dark:border-primary-800 hover:shadow-lg transition-all duration-300"
                  >
                    {/* Header */}
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                      ...
                      <div className="mt-4 lg:mt-0">
                        <span className="inline-flex items-center px-4 py-2 bg-primary-100 dark:bg-primary-800 text-primary-700 dark:text-primary-300 rounded-xl text-sm font-medium border border-primary-200 dark:border-primary-700">
                    ...
                    {/* Technologies */}
                    <div className="mb-6">
                      <h4 className="text-sm font-semibold text-primary-700 dark:text-primary-300 mb-3 uppercase tracking-wide">
                        Technologies Used
                      </h4>
                      <div className="flex flex-wrap gap-2">
                        {job.technologies.map((tech, techIndex) => (
                          <motion.span
                            ...
                            viewport={{ once: true }}
                            className="px-3 py-1 bg-white dark:bg-primary-800 text-primary-700 dark:text-primary-300 text-sm rounded-xl border border-primary-200 dark:border-primary-700"
                          >
                            {tech}
                          </motion.span>
                        ))}
                    ...
                    <div className="border-t border-primary-200 dark:border-primary-700 pt-6">
                      ...
                      <ul className="space-y-2">
                        {index === 0 && (
                          <>
                            <li className="flex items-start space-x-2 text-sm text-primary-600 dark:text-primary-400">
        ...
        >
          <div className="bg-primary-900 dark:bg-primary-50 rounded-2xl p-8 text-primary-50 dark:text-primary-900 shadow-sm border border-primary-800 dark:border-primary-200">
            ...
            <p className="text-primary-300 dark:text-primary-600 mb-6 max-w-2xl mx-auto leading-relaxed">
            ...
            <motion.button
              ...
              className="inline-flex items-center space-x-2 px-8 py-4 bg-white dark:bg-primary-900 text-primary-900 dark:text-primary-50 rounded-2xl font-semibold hover:bg-primary-100 dark:hover:bg-primary-800 transition-all duration-300 shadow-sm hover:shadow-md border border-primary-200 dark:border-primary-700"
            >
